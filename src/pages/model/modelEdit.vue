  ...
  <div class="model-edit">
    <el-form ref="modelForm" :model="model" :rules="modelRule" label-width="80px">
      ...
      <el-form-item label="字段">
        <el-tag v-for="item in field" size="medium" :key="item._id" class="el-tag-extr">
          {{item.cname}}
        </el-tag>
      ...
      <el-form ref="modelFieldForm" label-width='100px' :model="modelField">
        ...
        <el-form-item label="输入方式">
          <el-radio-group v-model="modelField.inputType" size="small">
            ...
            <el-radio label="fileimg">图片</el-radio>
            <el-radio label="filevideo">视频</el-radio>
...
export default {
  ...
  methods: {
    ...
    selectModelField() {
      this.model.fields = this.selectedModelField.map(item => item._id);
